...
const benefits = [
  {
    ...
    description:
      "Make an answer at what instance or resources sees written offense solutions.",
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Reheat entropy of experiment not-exponers instantiate antitoxes subdivits.",
    icon: (
      <svg
        className="w-6 h-6 text-white"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Chemetin all cases entered mod 6 sentences testing explosive crises. Extracalition.",
    icon: (
      <svg
        className="w-6 h-6 text-white"
        fill="none"
...
const Home = () => {
  return (
    <div className="overflow-x-hidden bg-linear-to-r from-indigo-900 via-black to-purple-900 h-full">
      {/* ================= HERO ================= */}
      <section className="py-28 md:py-32 text-center  text-white border-b border-white/20">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto mb-10">
            Transforming data into actionable intelligence with cutting-edge AI
            solutions.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-transparent border-2 border-white px-8 py-4 rounded-xl font-semibold text-white hover:bg-white/10 transition transform hover:-translate-y-1"
            >
              ChatNHS
            </Link>
          </div>
      ...
      {/* ================= WHAT WE DO ================= */}
      <section className="py-20 text-white border-b border-white/20">
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((s, i) => (
            <div
              key={i}
              className="p-8 bg-linear-to-br from-indigo-800 to-purple-800 rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition"
            >
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-900 via-black to-purple-900 text-white border-b border-white/20">
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          {benefits.map((b, i) => (
            <div
              key={i}
              className="p-8 bg-gradient-to-br from-indigo-800 to-purple-800 rounded-xl shadow-lg hover:shadow-2xl transition"
            >
              <div className="w-12 h-12 mb-4 flex items-center justify-center rounded-lg bg-indigo-700/40">
                {b.icon}
              </div>
